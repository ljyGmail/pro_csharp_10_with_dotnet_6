...
public class WorkingWithStringData
{
    ...
    public static void StringInterpolation()
    {
        ...
        // use dot notation on the variables
...
very
    very
        ...
        // Insert a double quote into a literal string by doubling the " token
        Console.WriteLine(@"Cerebus said ""Darrr! Pret-ty sun-sets""");

        // Verbatim strings can also be interpolated strings.
        // The order of $ and @ does not matter after C# 8.
